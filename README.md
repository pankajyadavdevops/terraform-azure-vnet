...
| <a name="input_managedby"></a> [managedby](#input\_managedby) | ManagedBy, eg 'info@pankajyadavdevops.com' | `string` | `"info@pankajyadavdevops.com"` | no |
| <a name="input_name"></a> [name](#input\_name) | Name  (e.g. `app` or `cluster`). | `string` | `""` | no |
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/pankajyadavdevops/terraform-azure-vnet"` | no |
